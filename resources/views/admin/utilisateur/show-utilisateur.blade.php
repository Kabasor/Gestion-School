                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="breadcrumb breadcrumb-style">
                            <li>
                                <h4 class="page-title">userile</h4>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="m-b-20">
                            <div class="contact-grid">
                                <div class="userile-header bg-dark">
                                    <div class="user-name">{{$user->nom}}</div>
                                    <div class="name-center">{{$user->prenom}}</div>
                                </div>

                                {{-- <img src="/image/{{ $user->image}}" class="user-img" alt=""> --}}
                                ...
                                <div>
                                    <p>Email : {{$user->email}}</h3>
                                </div>
                                <div>
                                    <p>Nationation : {{$user->nationalite}}</p>
                                </div>
                                <div>
                                    <p>Date de naissance : {{$user->dateNaissance}}</p>
                                </div>
                                <div>
                                    <p>Lieu de naissance : {{$user->lieuNaissance}}</p>
                                </div>
                                <div>
                                    <p>Diplôme : {{$user->diplome}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row clearfix">
                                        ...
                                        <div class="body">
                                            <div class="row">
                                                <div class="col-md-3 col-6 b-r">
                                                    ...
                                                    <br>
                                                    <p class="text-muted">{{$user->nom}} {{$user->prenom}}</p>
                                                </div>
                                                <div class="col-md-3 col-6 b-r">
                                                    <strong>Téléphone</strong>
                                                    <br>
                                                    <p class="text-muted">(+224) {{$user->phone}}</p>
                                                </div>
                                                <div class="col-md-3 col-6 b-r">
                                                    <strong>Email</strong>
                                                    <br>
                                            ...
                                            <p class="m-t-30">
                                                ...
                                                university
                                                from 1996-01.</p>
                                            <p>Worked as useressor and Head of the department at Sarda Collage, Rajkot,
                                                Gujarat
                                                from 2003-2015 </p>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="card project_widget">
                                        ...
                                        <div class="body">
                                            <ul>
                                                <li>One year experience as Jr. useressor from April-2009 to march-2010
                                                    at B.
                                                    J. Arts College, Ahmedabad.</li>
                                                <li>Three year experience as Jr. useressor at V.S. Arts &amp; Commerse
                                                    Collage
