                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('note_1') is-invalid @enderror" name="note_1" value=" {{$note->note_1}}" />
                                                @error('note_1')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('note_2') is-invalid @enderror" name="note_2" value=" {{$note->note_2}}" />
                                                @error('note_2')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('note_3') is-invalid @enderror" name="note_3" value=" {{$note->note_2}}" />
                                                @error('note_3')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('compos') is-invalid @enderror" name="compos" value=" {{$note->compos}}" />
                                                @error('compos')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
