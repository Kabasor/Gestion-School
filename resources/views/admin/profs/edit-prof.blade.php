                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-3 mt-3">
                                        <div class="form-group default-select select2Style">
                                            ...
                                            <select name="diplome" id="diplome" class="form-control select2 @error('diplome') is-invalid @enderror" data-placeholder="Séléctionnez le diplôme">
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('salaire') is-invalid @enderror" name="salaire" value=" {{$prof->salaire }}" />
                                            @error('salaire')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
