            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                        <form action=" {{route('emploie.update',$emploie)}} " method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                    <div class="row clearfix">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('jour') is-invalid @enderror" name="jour" value=" {{$emploie->jour}}" />
                                                @error('jour')
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('heure_debut') is-invalid @enderror" name="heure_debut" value=" {{$emploie->heure_debut}}" />
                                                @error('heure_debut')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('heure_fin') is-invalid @enderror" name="heure_fin" value=" {{$emploie->heure_fin}}" />
                                                @error('heure_fin')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('durer') is-invalid @enderror" name="durer" value=" {{$emploie->durer}}" />
                                                @error('durer')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
