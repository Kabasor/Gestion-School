            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                        <form action=" {{route('matiere.update',$matiere)}} " method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                    <div class="row clearfix">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('nom_matiere') is-invalid @enderror" name="nom_matiere" value="{{$matiere->nom_matiere}}" />
                                                @error('nom_matiere')
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('coefficient') is-invalid @enderror" name="coefficient" value="{{$matiere->coefficient}}"/>
                                                @error('coefficient')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
