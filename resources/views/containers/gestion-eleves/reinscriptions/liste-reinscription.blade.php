                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation">
                                    <a href="#home_with_icon_title" data-bs-toggle="tab" class="active show">
                                        <i class="material-icons">home</i> Liste simples des élèves reinscrits
                                    </a>
                                </li>
                                <li role="presentation">
                                    <a href="#profile_with_icon_title" data-bs-toggle="tab">
                                        <i class="material-icons">face</i> Liste complets des élèves reinscrits
                                    </a>
                                </li>
                                <li role="presentation">
                        ...
                        <div class="header">
                            <h2>
                                <button class="btn-hover btn-border-radius color-5">
                                    <a href="@route('print.reinscription')"><i class="bi bi-printer" style="color: #FFF">IMPRIMER</i></a>
                                </button>
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li>
                                    ...
                                    <button class="btn-hover btn-border-radius color-6">
                                        <a href=" {{route('reinscription.create')}} "><i class="bi bi-printer" style="color: #FFF">Reinscription</i></a>
                                    </button>
                                </li>
                            </ul>
                        </div>
