                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation">
                                    <a href="#home_with_icon_title" data-bs-toggle="tab" class="active show">
                                        <i class="material-icons">home</i> reinscription
                                    </a>
                                </li>
                                <li role="presentation">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="card">
                                                ...
                                                <div class="body">
                                                    <form action="@route('reinscription.store')" id="form_advanced_validation" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                           <div class="row mt-3">
                                                            <div class="col-sm-6">
                                            ...
                                            <tbody>
                                                @foreach ($reinscriptions as $reinscription)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('reinscription.show',$reinscription)}}" class="btn btn-tbl-edit">
                                                                <i class="material-icons">remove_red_eye</i>
                                                            </a>
                                                            <a href="{{route('reinscription.edit',$reinscription)}}" class="btn btn-tbl-edit">
                                                                <i class="material-icons">create</i>
                                                            </a>

                                                            <form style="display: inline" action="@route('reinscription.destroy', $reinscription)" method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button class="btn btn-tbl-delete btn-sm delete-confirm" data-name="{{$reinscription->id}}" type="submit">
                    ...
                    success: function(response) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 mt-3">
                                ...
                                <input disabled  type="text" class="form-control " name="libelle" value="${response.classe.libelle}"  required>
                            </div>
                    ...
                    success: function(response) {
                        ...
                        if(response.frais_scolarite) {
                            ...
                            data += `
                                <div class="row">
                                    <div class="col-sm-3 mt-3">
                                        <label>Reinscription : <span class="tx-danger">*</span></label>
                                        <input type="text"
                                            class="form-control champ reinscription  @error('prix_reinscription') is-invalid @enderror"
                                            name="reinscription" id="reinscription"
                                            value="${response.frais_scolarite.reinscription}"
                                            disabled required
                                        >
                                    </div>
