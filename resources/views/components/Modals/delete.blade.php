...
<form action=" {{route('eleve.destroy',$eleve)}} " method="POST" >
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <div class="modal" id="modale" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Modal title</h5>
                        <button type="button" class="close" data-bs-dismiss="modal" onclick="document.getElementById('modale').style.display='none' "
                            aria-label="Close">
                    ...
                    <div class="modal-footer">
                        <button type="submit"class="btn btn-info waves-effect" >Suprimer</button>
                        <button type="button" class="btn btn-danger waves-effect" onclick="document.getElementById('modale').style.display='none' " data-bs-dismiss="modal">Annuler</button>
                    </div>
                </div>
            </div>
        </div>
